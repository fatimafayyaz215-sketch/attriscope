    ...
    <>
      ...
      <div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-lg pl-10 pr-10 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
              />
              <button
                type="button"
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs text-gray-400 uppercase tracking-widest">or sign in with</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
