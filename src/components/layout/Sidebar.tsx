    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen fixed top-0 left-0">
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50/50">
        ...
        <ul className="flex flex-col gap-1">
          <li>
            <Link href="/support" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-100/50">
          ...
          <li>
            <Link href="/docs" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-100/50">
              <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
